...
def get_token():
    with sync_playwright() as p:
        ...
        try:
            # Direct link to soccer section
            page.goto("https://www.betika.com/en-ke/s/soccer", wait_until="domcontentloaded", timeout=60000)
        except Exception as e:
            print(f"Navigation info: {e}")

        # Wait up to 20 seconds for the token
        for _ in range(20):
...
def main():
    ...
    if not token:
        print("FAILED: No token found. Creating log and exiting.")
